...
import { JobResultsSheetComponent } from './job-results-sheet.component';
...
describe('JobResultsSheetComponent', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [JobResultsSheetComponent],
      providers: [provideRouter([])],
    });
  });

  it('renders skeleton placeholders while loading', async () => {
    const fixture = TestBed.createComponent(JobResultsSheetComponent);
